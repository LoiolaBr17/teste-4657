...
const bannersMobile = ref([{
  foto: "https://portalvhdsjg19kbq1q36k1.blob.core.windows.net/babyemommy/banner/Banner.png",
  fotoWebp: "https://portalvhdsjg19kbq1q36k1.blob.core.windows.net/babyemommy/banner/Banner.png",
  id: 103,
  ordem: 1,
  posicionamento: "topo",
  status: true
...
async function searchTopBanners () {
  try {
    const banners = await axios.get("https://babyemommy.com.br/api/bannerService/allEcommerce").then(e => e.data);
...
async function searchMobileBanners () {
  try {
    const banners = await axios.get("https://babyemommy.com.br/api/bannerService/all").then(e => e.data);
