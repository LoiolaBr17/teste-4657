...
const categoriasCarousel = ref([
  {
    descricao: "CARTEIRAS",
    fotoUrl: "https://cs210033fff90d2f7ac.blob.core.windows.net/babyemommy/categoria-autorelacionada-servico/3368imagem2023-09-28T11:56:50.209.png",
  ...
  {
    descricao: "BOLSAS",
    fotoUrl: "https://cs210033fff90d2f7ac.blob.core.windows.net/babyemommy/categoria-autorelacionada-servico/2913imagem2023-09-28T11:53:44.207.png",
...
async function searchCategories () {
  try {
    const categorias = await axios.get("https://babyemommy.com.br/api/ecommerce/categoriaAutoRelacionada/getAllCategorias").then(e => e.data);
